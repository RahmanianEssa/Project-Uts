...
public class ProductPrintAdapter extends RecyclerView.Adapter<ProductPrintAdapter.ViewHolder> {
    private Context context;
    private List<Produk> items;

    public ProductPrintAdapter(Context context, List<Produk> items) {
